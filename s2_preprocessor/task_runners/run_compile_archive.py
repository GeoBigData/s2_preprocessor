...
import os
import json
from s2_preprocessor import compile_archive
...
def main():
    ...
    tiles = inputs.get('tiles', None)
    bands = inputs.get('bands', None)
    ...
    tiles = convert_type(tiles, str, 'String')
    bands = convert_type(bands, str, 'String')
